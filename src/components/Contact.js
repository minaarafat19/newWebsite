...
export const Contact = () => {
  ...
  function sendEmail(e) {
    ...
    emailjs.sendForm('service_l16ftb7', 'template_6c9na3n', e.target, 'hSKe7IxKrcwC8LM3N', this)
      .then((result) => {
      ...
      <Container>
        <Row className="align-items-center">
          <Col size={12} md={6}>
            <TrackVisibility>
              {({ isVisible }) =>
                <img className={isVisible ? "animate__animated animate__zoomIn" : ""} src={picc} alt="Contact Us"/>
              }
            </TrackVisibility>
          </Col>
          <Col size={12} md={6}>
              ...
              {({ isVisible }) =>
                ...
                <form enctype="multipart/form-data" method="post"  onSubmit={sendEmail}>
                  <Row>
                    ...
                    <Col size={12} sm={6} className="px-1">
                      <input type="tel" placeholder="Num telephone" name="num"/>
                    </Col>
